...
Vector3f operator*(const Vector3f & vector,Matrix3D matrix)
{
	...
	return Vector3f(
		vector[0] * mt[0][0] + vector[1] * mt[1][0] + vector[2] * mt[2][0],
		vector[0] * mt[0][1] + vector[1] * mt[1][1] + vector[2] * mt[2][1],
		vector[0] * mt[0][2] + vector[1] * mt[1][2] + vector[2] * mt[2][2]
		);
}
...
Vector4f operator*(const Vector4f & vector, Matrix4D matrix)
{
	...
	return Vector4f(
		vector[0] * mt[0][0] + vector[1] * mt[1][0] + vector[2] * mt[2][0] + vector[3] * mt[3][0],
		vector[0] * mt[0][1] + vector[1] * mt[1][1] + vector[2] * mt[2][1] + vector[3] * mt[3][1],
		vector[0] * mt[0][2] + vector[1] * mt[1][2] + vector[2] * mt[2][2] + vector[3] * mt[3][2],
		vector[0] * mt[0][3] + vector[1] * mt[1][3] + vector[2] * mt[2][3] + vector[3] * mt[3][3]
		);
}
